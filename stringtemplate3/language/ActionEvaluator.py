    ...
    def templateApplication(self, _t):
        ...
        try:  ## for error handling
            ...
            if False:
                ...
                if _cnt16 < 1:
                    raise antlr.NoViableAltException(_t)
                value = self.chunk.applyListOfAlternatingTemplates(
                    self.this, a, templatesToApply
                )
                _t = _t14
                _t = _t.getNextSibling()
                ...
                value = self.chunk.applyTemplateToListOfAttributes(
                    self.this, attributes, anon.getStringTemplate()
                )
                _t = _t17
                _t = _t.getNextSibling()
            else:
            ...
            if False:
                ...
                if at.getText():
                    ...
                    valueST = StringTemplate(
                        group=self.this.group, template=at.getText()
                    )
    ...
    def template(self, _t, templatesToApply):
        ...
        try:  ## for error handling
            ...
            if False:
                ...
                embedded = group.getEmbeddedInstanceOf(templateName, self.this)
                if embedded:
            ...
            if False:
                ...
                if e:
                    self.this.rawSetArgumentAttribute(
                        embedded, argumentContext, arg.getText(), e
                    )
    ...
    def singleTemplateArg(self, _t, embedded, argumentContext):
        ...
        try:  ## for error handling
            ...
            if error:
                ...
                self.this.rawSetArgumentAttribute(
                    embedded, argumentContext, soleArgName, e
                )

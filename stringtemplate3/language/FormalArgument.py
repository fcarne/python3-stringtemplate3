...
suffixes = [None, "?", "", None, "*", None, None, None, "+"]
...
class FormalArgument:
    ...
    def __eq__(self, other):
        ...
        if (self.defaultValueST is not None and other.defaultValueST is None) or (
            self.defaultValueST is None and other.defaultValueST is not None
        ):
            return False
